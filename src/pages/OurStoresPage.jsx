  ...
  useEffect(() => {
    ...
    BRANCHES.forEach(b => {
      ...
      marker.addListener('click', () => {
        ...
        const dirUrl = `https://www.google.com/maps/dir/?api=1&origin=My+Location&destination_place_id=${b.placeId}&travelmode=driving`
                  ...
                  <div style={{
                    ...
                    <div style={{ flex: 1, minWidth: '200px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '0' }}>
                        ...
                        {(() => {
                          const dirUrl = `https://www.google.com/maps/dir/?api=1&origin=My+Location&destination_place_id=${activeBranch.placeId}&travelmode=driving`
                          return (
                            <a href={dirUrl} target="_blank" rel="noopener noreferrer"
                              style={{
