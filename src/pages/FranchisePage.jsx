        ...
        <div key={`info-${current}`} className="cart-info-enter">
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 28px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {cart.highlights.map((h, i) => (
              <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', fontFamily: 'Nunito, sans-serif', fontSize: '14px', color: '#8A5F3C' }}>
...
function InquiryForm() {
  ...
  if (sent) return (
    <div style={{ textAlign: 'center', padding: '48px 24px' }}>
      ...
      <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '24px', fontWeight: '800', color: '#b6c548', marginBottom: '8px' }}>
        Thank you for your interest!
      </h3>
      <p style={{ fontFamily: 'Nunito, sans-serif', fontSize: '15px', color: '#8A5F3C', maxWidth: '400px', margin: '0 auto' }}>
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
        <div>
          <label style={{ fontFamily: 'Nunito, sans-serif', fontSize: '12px', fontWeight: '700', color: '#8A5F3C', display: 'block', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Full Name *</label>
        ...
        <div>
          <label style={{ fontFamily: 'Nunito, sans-serif', fontSize: '12px', fontWeight: '700', color: '#8A5F3C', display: 'block', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Email Address *</label>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
        <div>
          <label style={{ fontFamily: 'Nunito, sans-serif', fontSize: '12px', fontWeight: '700', color: '#8A5F3C', display: 'block', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Phone Number *</label>
        ...
        <div>
          <label style={{ fontFamily: 'Nunito, sans-serif', fontSize: '12px', fontWeight: '700', color: '#8A5F3C', display: 'block', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Preferred Location</label>
      ...
      <div>
        <label style={{ fontFamily: 'Nunito, sans-serif', fontSize: '12px', fontWeight: '700', color: '#8A5F3C', display: 'block', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Preferred Cart Format</label>
      ...
      <div>
        <label style={{ fontFamily: 'Nunito, sans-serif', fontSize: '12px', fontWeight: '700', color: '#8A5F3C', display: 'block', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Tell us about yourself</label>
  ...
  return (
    <>
      ...
      <div className="page-enter">
        ...
        <section style={{
          ...
          <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <h1 style={{
              ...
              color: '#3a6b35', lineHeight: '1.15', margin: '0 0 16px',
            }}>
        ...
        {/* ── CART SLIDESHOW ── */}
        <section style={{ background: '#F4FAEC', padding: '72px 0' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: 'clamp(1.6rem, 3vw, 2.25rem)', fontWeight: '800', color: '#3a6b35', margin: '0 0 8px' }}>
              Choose Your Format
            </h2>
            <p style={{ fontFamily: 'Nunito, sans-serif', fontSize: '15px', color: 'rgba(138,95,60,0.7)', margin: 0 }}>
        ...
        {/* ── WHY AVOCADORIA ── */}
        <section style={{ background: 'linear-gradient(135deg, #3a6b35, #b6c548)', padding: '72px 32px', textAlign: 'center' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: 'clamp(1.6rem, 3vw, 2.25rem)', fontWeight: '800', color: '#fff', margin: '0 0 48px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontFamily: 'Nunito, sans-serif', fontSize: '16px', fontWeight: '800', color: '#fff', marginBottom: '6px' }}>{w.title}</div>
                  <div style={{ fontFamily: 'Nunito, sans-serif', fontSize: '13px', color: 'rgba(255,255,255,0.8)', lineHeight: '1.5' }}>{w.desc}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ── HOW IT WORKS ── */}
        <section style={{ background: '#F4FAEC', padding: '72px 32px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '52px' }}>
              <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: 'clamp(1.6rem, 3vw, 2.25rem)', fontWeight: '800', color: '#3a6b35', margin: '0 0 8px' }}>
                How to Get Started
              </h2>
              <p style={{ fontFamily: 'Nunito, sans-serif', fontSize: '15px', color: 'rgba(138,95,60,0.7)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
              {STEPS.map((step, i) => (
                <div key={i} style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', position: 'relative', paddingBottom: i < STEPS.length - 1 ? '36px' : '0' }}>
                  {/* Connector line */}
                  {i < STEPS.length - 1 && (
                    <div style={{ position: 'absolute', left: '28px', top: '56px', width: '2px', height: 'calc(100% - 20px)', background: 'rgba(182,197,72,0.25)', zIndex: 0 }} />
                  )}
                  {/* Step number circle */}
                  ...
                  <div style={{ paddingTop: '10px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                      <span style={{ fontFamily: 'Nunito, sans-serif', fontSize: '11px', fontWeight: '700', color: '#b6c548', letterSpacing: '0.08em' }}>STEP {step.num}</span>
                      <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '18px', fontWeight: '800', color: '#3a6b35', margin: 0 }}>{step.title}</h3>
                    </div>
                    <p style={{ fontFamily: 'Nunito, sans-serif', fontSize: '14px', color: 'rgba(138,95,60,0.8)', lineHeight: '1.65', margin: 0 }}>{step.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* ── INQUIRY FORM ── */}
        <section id="franchise-inquiry" style={{ background: '#D0E8AF', padding: '72px 32px' }}>
          <div style={{ maxWidth: '760px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '40px' }}>
              <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: 'clamp(1.6rem, 3vw, 2.25rem)', fontWeight: '800', color: '#3a6b35', margin: '0 0 8px' }}>
                Ready to Join the Family?
              </h2>
              <p style={{ fontFamily: 'Nunito, sans-serif', fontSize: '15px', color: '#8A5F3C', opacity: 0.85 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '36px' }}>
              {[
                ...
                >
                  ...
                  <span style={{ fontFamily: 'Nunito, sans-serif', fontSize: '11px', fontWeight: '700', color: '#b6c548', textTransform: 'uppercase', letterSpacing: '0.05em' }}>{c.label}</span>
                  <span style={{ fontFamily: 'Nunito, sans-serif', fontSize: '12px', color: '#8A5F3C', textAlign: 'center' }}>{c.value}</span>
                </a>
              ))}
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '28px' }}>
              ...
              <span style={{ fontFamily: 'Nunito, sans-serif', fontSize: '12px', color: 'rgba(138,95,60,0.6)', whiteSpace: 'nowrap' }}>or fill out the form</span>
              <div style={{ flex: 1, height: '1px', background: 'rgba(182,197,72,0.3)' }}/>
            </div>
